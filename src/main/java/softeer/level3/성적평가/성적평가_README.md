<h3 align="center"> 
    📢 softeer(성적평가) : https://softeer.ai/practice/info.do?idx=1&eid=1309&sw_prbl_sbms_sn=205372
</h3>
...
출력 : 첫 세 개의 줄에는 각 참가자의 대회별 등수를 출력한다. 즉 이중 c번째 줄의 i번째 정수는 c번째 대회에서의 i번째 사람의 등수를 의미한다.
